    ...
    $('#edit-option').dialog({
            ...
            buttons: {
                ...
                "Confirm": function () {
                    ...
                    var $renamedTask = $(taskHTML);
                    var idAttr = toBeDeleted.find('.task').attr('id');
                    $.ajax({
                        method: 'PUT',
                        url: 'https://floating-garden-64913.herokuapp.com/task_edit/' + editedTask + '/' + idAttr,
                       /* data: JSON.stringify({
                            id: idAttr, task:editedTask
                        }),*/
                        contentType: "application/json",
                        success:function () {
                            $renamedTask.hide();
    ...
    $('#delete-option').dialog({ //opens delete option dialog
        ...
        buttons: {
            ...
            "Confirm": function () { //removes it from the list
                ...
                $.ajax({
                    method: 'DELETE',
                    url: 'https://floating-garden-64913.herokuapp.com/delete_task/' + id_task,
                    /*data: JSON.stringify({
                        id: id_task
                    }), */
                    contentType: "application/json",
